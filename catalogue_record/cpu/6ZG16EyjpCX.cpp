...
static ffi::Error sdot_ffi_impl( ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR1<ffi::F64> ffi_weights, ffi::BufferR1<ffi::S64> ffi_order, ffi::BufferR1<ffi::S32> ffi_nb_points, ffi::BufferR1<ffi::S64> ffi_begin, ffi::BufferR1<ffi::S64> ffi_end, ffi::BufferR1<ffi::S64> ffi_leaf_size, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_positions_, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_weights_, ffi::Result<ffi::BufferR1<ffi::S64>> ffi_order_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_points_, ffi::Result<ffi::BufferR1<ffi::S64>> ffi_mid, ffi::Result<ffi::BufferR3<ffi::F64>> ffi_box, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_wa, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_wb, ffi::Result<ffi::BufferR1<ffi::S64>> ffi_perm, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t max_ffi_nb_points, int64_t max_ffi_nb_points_, int64_t nb_batch_bspnode_0 ) {
    ...
    auto src = _BspCloud{
        ...
        tensor_view<CpuHostMemorySpace>( ffi_order.typed_data(), tuple( SI( ffi_order.dimensions()[ 0 ] ) ), tuple( num_point ) ),
        make_shape_var_view( tensor_view<CpuHostMemorySpace>( ffi_nb_points.typed_data(), tuple(  ), tuple(  ) ), SI( max_ffi_nb_points ), NoErrorBuffer{}, SI( -1 ) ),
        Ct<SI, 3>{}
    };
    auto src_io = _BspCloud_io{ InpList(), InpList(), InpList(), InpList(), InpList() };
    auto dst = _BspCloud{
        tensor_view<CpuHostMemorySpace>( ffi_positions_->typed_data(), tuple( SI( ffi_positions_->dimensions()[ 0 ] ), Ct<SI, 3>() ), tuple( num_point, dim ) ),
        tensor_view<CpuHostMemorySpace>( ffi_weights_->typed_data(), tuple( SI( ffi_weights_->dimensions()[ 0 ] ) ), tuple( num_point ) ),
        tensor_view<CpuHostMemorySpace>( ffi_order_->typed_data(), tuple( SI( ffi_order_->dimensions()[ 0 ] ) ), tuple( num_point ) ),
        make_shape_var_view( tensor_view<CpuHostMemorySpace>( ffi_nb_points_->typed_data(), tuple(  ), tuple(  ) ), SI( max_ffi_nb_points_ ), NoErrorBuffer{}, SI( -1 ) ),
        Ct<SI, 3>{}
    };
    auto dst_io = _BspCloud_io{ OutList(), OutList(), OutList(), OutList(), InpList() };
    auto lvl = _BspLevel{
        tensor_view<CpuHostMemorySpace>( ffi_begin.typed_data(), tuple( SI( ffi_begin.dimensions()[ 0 ] ) ), tuple( bspnode_0 ) ),
        tensor_view<CpuHostMemorySpace>( ffi_end.typed_data(), tuple( SI( ffi_end.dimensions()[ 0 ] ) ), tuple( bspnode_0 ) ),
        tensor_view<CpuHostMemorySpace>( ffi_mid->typed_data(), tuple( SI( ffi_mid->dimensions()[ 0 ] ) ), tuple( bspnode_0 ) ),
        tensor_view<CpuHostMemorySpace>( ffi_box->typed_data(), tuple( SI( ffi_box->dimensions()[ 0 ] ), Ct<SI, 2>(), Ct<SI, 3>() ), tuple( bspnode_0, num_lohi, dim ) ),
        tensor_view<CpuHostMemorySpace>( ffi_wa->typed_data(), tuple( SI( ffi_wa->dimensions()[ 0 ] ), Ct<SI, 3>() ), tuple( bspnode_0, dim ) ),
        tensor_view<CpuHostMemorySpace>( ffi_wb->typed_data(), tuple( SI( ffi_wb->dimensions()[ 0 ] ) ), tuple( bspnode_0 ) ),
        Ct<SI, 2>{},
        Ct<SI, 3>{}
    };
    auto lvl_io = _BspLevel_io{ InpList(), InpList(), OutList(), OutList(), OutList(), OutList(), InpList(), InpList() };
    auto perm = tensor_view<CpuHostMemorySpace>( ffi_perm->typed_data(), tuple( SI( ffi_perm->dimensions()[ 0 ] ) ), tuple( num_point ) );
    auto leaf_size = tensor_view<CpuHostMemorySpace>( ffi_leaf_size.typed_data(), tuple( SI( ffi_leaf_size.dimensions()[ 0 ] ) ), tuple( num_bsp_param ) );
    errors.fill_with( queue, 0 );
    dst.positions.fill_with( queue, 0 );
    dst.weights.fill_with( queue, 0 );
    dst.order.fill_with( queue, 0 );
    dst.nb_points.fill_with( queue, 0 );
    lvl.mid.fill_with( queue, 0 );
    lvl.box.fill_with( queue, 0 );
    lvl.wa.fill_with( queue, 0 );
    lvl.wb.fill_with( queue, 0 );
    {
run_parallel(
    queue,
