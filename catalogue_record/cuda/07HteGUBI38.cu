...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_direction, ffi::BufferR0<ffi::F64> ffi_offset, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_vertex_positions_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_cut_ids_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_vertices_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_cuts_, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t attr_cut_id, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_vertices_, int64_t max_ffi_nb_cuts_, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words ) {
    ...
    auto direction = tensor_view<CudaGlobalMemorySpace>( ffi_direction.typed_data(), tuple( Ct<SI, 2>() ), tuple( dim_axis ) );
    ...
    auto res = Cell_2{
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_positions_->typed_data(), tuple( SI( ffi_vertex_positions_->dimensions()[ 0 ] ), Ct<SI, 2>() ), tuple( num_vertex, dim_axis ) ),
