...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR0<ffi::F64> ffi_target_mass, ffi::BufferR1<ffi::S32> ffi_shape, ffi::BufferR3<ffi::F64> ffi_values, ffi::Result<ffi::BufferR0<ffi::F64>> ffi_current_mass, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t max_ffi_shape ) {
