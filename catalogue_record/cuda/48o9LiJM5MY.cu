...
#include "sdot/generated/aggregates/Neighbors_full.h"
...
struct power_diagram_hessian_rows_fwd_kernel {
    template<class BatchIndex, class T_power_diagram, class T_dom_cell, class T_ranks, class T_scratch, class T_nbrs>
    HD void operator()( BatchIndex batch_index, int thread_index, int nb_threads, T_power_diagram power_diagram, T_dom_cell dom_cell, T_ranks ranks, T_scratch scratch, T_nbrs nbrs ) const {
        power_diagram.hessian_row( SI( ranks( batch_index ) ), dom_cell, nbrs( batch_index ), scratch, thread_index, power_diagram.unit_density() );
    }
};


static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_node_wa, ffi::BufferR1<ffi::F64> ffi_node_wb, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR1<ffi::F64> ffi_sorted_weights, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR1<ffi::S64> ffi_ranks, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_ids, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_vals, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_nbrs, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t max_ffi_nb_nbrs, int64_t nb_batch_cell_0 ) {
    ...
    auto power_diagram = PowerDiagram_Bsp{
        ...
        tensor_view<CudaGlobalMemorySpace>( ffi_sorted_weights.typed_data(), tuple( SI( ffi_sorted_weights.dimensions()[ 0 ] ) ), tuple( num_point ) ),
    ...
    auto power_diagram_io = PowerDiagram_Bsp_io{ InpList(), InpList(), UndefList(), UndefList(), InpList(), UndefList(), InpList(), AaBsp_io{ InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), InpList() }, InpList(), InpList(), UndefList(), UndefList(), InpList() };
    ...
    auto ranks = tensor_view<CudaGlobalMemorySpace>( ffi_ranks.typed_data(), tuple( SI( ffi_ranks.dimensions()[ 0 ] ) ), tuple( cell_0 ) );
    ...
    auto nbrs = Neighbors{
        tensor_view<CudaGlobalMemorySpace>( ffi_ids->typed_data(), tuple( SI( 200 ), SI( 16 ) ), tuple( cell_0, num_nbr ), tuple( SI( 64 ), SI( 4 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_vals->typed_data(), tuple( SI( 200 ), SI( 16 ) ), tuple( cell_0, num_nbr ), tuple( SI( 128 ), SI( 8 ) ) ),
        make_shape_var_view( tensor_view<CudaGlobalMemorySpace>( ffi_nb_nbrs->typed_data(), tuple( SI( ffi_nb_nbrs->dimensions()[ 0 ] ) ), tuple( cell_0 ) ), SI( max_ffi_nb_nbrs ), errors, SI( 2 ) )
    };
    auto nbrs_io = Neighbors_io{ OutList(), OutList(), OutList() };
    ...
    nbrs.ids.fill_with( queue, 0 );
    nbrs.vals.fill_with( queue, 0 );
    nbrs.nb_nbrs.fill_with( queue, 0 );
    {
run_parallel(
    queue,
    global_batch_indices,
    with_max_threads( scratch.words.shape( 0 ), power_diagram_hessian_rows_fwd_kernel{} ),
    power_diagram_io, power_diagram, dom_cell_io, dom_cell, InpList(), ranks, scratch_io, scratch, nbrs_io, nbrs
);
    }
