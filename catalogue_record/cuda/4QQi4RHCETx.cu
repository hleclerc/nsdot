...
struct power_diagram_measures_fwd_kernel {
    template<class BatchIndex, class T_power_diagram, class T_dom_cell, class T_res, class T_scratch, class T_memo_nbrs_out, class T_memo_counts_out>
    HD void operator()( BatchIndex batch_index, int thread_index, int nb_threads, T_power_diagram power_diagram, T_dom_cell dom_cell, T_res res, T_scratch scratch, T_memo_nbrs_out memo_nbrs_out, T_memo_counts_out memo_counts_out ) const {
        power_diagram.measures( res, dom_cell, scratch( batch_index ), power_diagram.unit_density(), memo_nbrs_out, memo_counts_out, thread_index, nb_threads );
    }
};


static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_node_wa, ffi::BufferR1<ffi::F64> ffi_node_wb, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR1<ffi::F64> ffi_sorted_weights, ffi::BufferR2<ffi::S32> ffi_memo_nbrs, ffi::BufferR1<ffi::S32> ffi_memo_counts, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR2<ffi::S32> ffi_vertex_cuts, ffi::BufferR2<ffi::S32> ffi_vertex_nbrs, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_res, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_memo_nbrs_out, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_memo_counts_out, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t nb_batch_thread_0 ) {
    ...
    auto scratch = CellScratch{
        tensor_view<CudaGlobalMemorySpace>( ffi_words->typed_data(), tuple( SI( 200 ), SI( 1 ), SI( 6144 ) ), tuple( thread_0, num_thread, num_word ), tuple( SI( 24576 ), SI( 24576 ), SI( 4 ) ) ),
    ...
    auto memo_nbrs_out = tensor_view<CudaGlobalMemorySpace>( ffi_memo_nbrs_out->typed_data(), tuple( SI( ffi_memo_nbrs_out->dimensions()[ 0 ] ), SI( ffi_memo_nbrs_out->dimensions()[ 1 ] ) ), tuple( num_point, num_memo ) );
    auto memo_counts_out = tensor_view<CudaGlobalMemorySpace>( ffi_memo_counts_out->typed_data(), tuple( SI( ffi_memo_counts_out->dimensions()[ 0 ] ) ), tuple( num_point ) );
...
run_parallel(
    ...
    power_diagram_io, power_diagram, dom_cell_io, dom_cell, OutList(), res, scratch_io, scratch, OutList(), memo_nbrs_out, OutList(), memo_counts_out
);
    }
