...
struct power_diagram_measures_fwd_kernel {
    template<class BatchIndex, class T_power_diagram, class T_dom_cell, class T_res, class T_scratch, class T_distribution>
    HD void operator()( BatchIndex batch_index, int thread_index, int nb_threads, T_power_diagram power_diagram, T_dom_cell dom_cell, T_res res, T_scratch scratch, T_distribution distribution ) const {
        power_diagram.measures( res, dom_cell, scratch( batch_index ), distribution, 0, 0, thread_index, nb_threads );
    }
};


static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR0<ffi::F64> ffi_target_mass, ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR1<ffi::F64> ffi_sigmas, ffi::BufferR1<ffi::F64> ffi_weights, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_res, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t count_distribution_nb_gaussians, int64_t nb_batch_thread_0 ) {
    ...
    auto scratch = CellScratch{
        tensor_view<CudaGlobalMemorySpace>( ffi_words->typed_data(), tuple( SI( 200 ), SI( 1 ), SI( 832 ) ), tuple( thread_0, num_thread, num_word ), tuple( SI( 3328 ), SI( 3328 ), SI( 4 ) ) ),
    ...
    auto distribution = SumOfGaussians{
        tensor_view<CudaGlobalMemorySpace>( ffi_target_mass.typed_data(), tuple(  ), tuple(  ) ),
        make_shape_var_view( ScalarValue<SI>{ SI( count_distribution_nb_gaussians ) }, SI( -1 ), NoErrorBuffer{}, SI( -1 ) ),
        Ct<SI, 2>{},
        tensor_view<CudaGlobalMemorySpace>( ffi_positions.typed_data(), tuple( SI( ffi_positions.dimensions()[ 0 ] ), Ct<SI, 2>() ), tuple( num_gaussian, dim ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_sigmas.typed_data(), tuple( SI( ffi_sigmas.dimensions()[ 0 ] ) ), tuple( num_gaussian ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_weights.typed_data(), tuple( SI( ffi_weights.dimensions()[ 0 ] ) ), tuple( num_gaussian ) ),
        NoneTensor<double, Tuple<>, Tuple<>>{}
    };
    auto distribution_io = SumOfGaussians_io{ InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), UndefList() };
...
run_parallel(
    ...
    power_diagram_io, power_diagram, dom_cell_io, dom_cell, OutList(), res, scratch_io, scratch, distribution_io, distribution
);
    }
...
XLA_FFI_DEFINE_HANDLER_SYMBOL( SDOT_FFI_ENTRY, sdot_ffi_impl,
    ffi::Ffi::Bind()
        ...
        .Attr<int64_t>( "count_distribution_nb_gaussians" )
