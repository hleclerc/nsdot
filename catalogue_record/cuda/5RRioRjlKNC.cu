...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR1<ffi::F64> ffi_weights, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR1<ffi::S64> ffi_ranks, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_ids, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_vals, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_nbrs, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t max_ffi_nb_nbrs, int64_t nb_batch_cell_0 ) {
    ...
    auto power_diagram = PowerDiagram_Plain{
        ...
        tensor_view<CudaGlobalMemorySpace>( ffi_weights.typed_data(), tuple( SI( ffi_weights.dimensions()[ 0 ] ) ), tuple( num_point ) )
    };
