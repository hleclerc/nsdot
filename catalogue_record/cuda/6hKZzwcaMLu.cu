...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_origin, ffi::BufferR2<ffi::F64> ffi_axes, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_vertex_positions, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_cut_ids, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_vertices, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_cuts, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t attr_cut_id, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words ) {
    ...
    auto origin = tensor_view<CudaGlobalMemorySpace>( ffi_origin.typed_data(), tuple( Ct<SI, 2>() ), tuple( dim_axis ) );
    auto axes = tensor_view<CudaGlobalMemorySpace>( ffi_axes.typed_data(), tuple( Ct<SI, 2>(), SI( ffi_axes.dimensions()[ 1 ] ) ), tuple( dim_axis, num_axis ) );
    auto cell = Cell_2{
