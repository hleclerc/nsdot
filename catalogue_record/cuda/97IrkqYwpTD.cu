...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR2<ffi::S32> ffi_memo_nbrs, ffi::BufferR1<ffi::S32> ffi_memo_counts, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR2<ffi::S32> ffi_vertex_cuts, ffi::BufferR2<ffi::S32> ffi_vertex_nbrs, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR0<ffi::F64> ffi_target_mass, ffi::BufferR1<ffi::S32> ffi_shape, ffi::BufferR3<ffi::F64> ffi_values, ffi::BufferR0<ffi::F64> ffi_current_mass, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_mass, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_first, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_second, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t max_ffi_shape, int64_t nb_batch_thread_0 ) {
    ...
    auto distribution = Image{
        ...
        tensor_view<CudaGlobalMemorySpace>( ffi_values.typed_data(), tuple( SI( ffi_values.dimensions()[ 0 ] ), SI( ffi_values.dimensions()[ 1 ] ), SI( ffi_values.dimensions()[ 2 ] ) ), tuple( img_pos_0, img_pos_1, img_pos_2 ) ),
