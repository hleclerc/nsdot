...
struct power_diagram_moments_fwd_kernel {
    template<class BatchIndex, class T_power_diagram, class T_dom_cell, class T_mass, class T_first, class T_second, class T_scratch, class T_distribution>
    HD void operator()( BatchIndex batch_index, int thread_index, int nb_threads, T_power_diagram power_diagram, T_dom_cell dom_cell, T_mass mass, T_first first, T_second second, T_scratch scratch, T_distribution distribution ) const {
        power_diagram.moments( mass, first, second, dom_cell, scratch( batch_index ), distribution, thread_index, nb_threads );
    }
};


static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR0<ffi::F64> ffi_target_mass, ffi::BufferR1<ffi::S32> ffi_shape, ffi::BufferR2<ffi::F64> ffi_values, ffi::BufferR0<ffi::F64> ffi_current_mass, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_mass, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_first, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_second, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t max_ffi_shape, int64_t nb_batch_thread_0 ) {
    ...
    auto power_diagram = PowerDiagram_Bsp{
        tensor_view<CudaGlobalMemorySpace>( ffi_box_min.typed_data(), tuple( Ct<SI, 2>() ), tuple( dim ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_box_max.typed_data(), tuple( Ct<SI, 2>() ), tuple( dim ) ),
        ...
        Ct<SI, 2>{},
        AaBsp{ tensor_view<CudaGlobalMemorySpace>( ffi_seed_indices.typed_data(), tuple( SI( ffi_seed_indices.dimensions()[ 0 ] ) ), tuple( num_bsp_seed ) ), tensor_view<CudaGlobalMemorySpace>( ffi_node_left.typed_data(), tuple( SI( ffi_node_left.dimensions()[ 0 ] ) ), tuple( num_bsp_node ) ), tensor_view<CudaGlobalMemorySpace>( ffi_node_right.typed_data(), tuple( SI( ffi_node_right.dimensions()[ 0 ] ) ), tuple( num_bsp_node ) ), tensor_view<CudaGlobalMemorySpace>( ffi_node_begin.typed_data(), tuple( SI( ffi_node_begin.dimensions()[ 0 ] ) ), tuple( num_bsp_node ) ), tensor_view<CudaGlobalMemorySpace>( ffi_node_end.typed_data(), tuple( SI( ffi_node_end.dimensions()[ 0 ] ) ), tuple( num_bsp_node ) ), tensor_view<CudaGlobalMemorySpace>( ffi_node_box.typed_data(), tuple( SI( ffi_node_box.dimensions()[ 0 ] ), Ct<SI, 2>(), Ct<SI, 2>() ), tuple( num_bsp_node, num_lohi, dim ) ), NoneTensor<double, Tuple<SI, Ct<SI, 2>>, Tuple<_num_bsp_node, _dim>>{}, NoneTensor<double, Tuple<SI>, Tuple<_num_bsp_node>>{}, make_shape_var_view( ScalarValue<SI>{ SI( count_power_diagram_tree_nb_bsp_seeds ) }, SI( -1 ), NoErrorBuffer{}, SI( -1 ) ), make_shape_var_view( ScalarValue<SI>{ SI( count_power_diagram_tree_nb_bsp_nodes ) }, SI( -1 ), NoErrorBuffer{}, SI( -1 ) ), Ct<SI, 2>{}, Ct<SI, 2>{} },
        tensor_view<CudaGlobalMemorySpace>( ffi_sorted_positions.typed_data(), tuple( SI( ffi_sorted_positions.dimensions()[ 0 ] ), Ct<SI, 2>() ), tuple( num_point, dim ) ),
        NoneTensor<double, Tuple<SI>, Tuple<_num_point>>{},
        NoneTensor<std::int32_t, Tuple<SI, SI>, Tuple<_num_point, _num_memo>>{},
        NoneTensor<std::int32_t, Tuple<SI>, Tuple<_num_point>>{},
        make_shape_var_view( ScalarValue<SI>{ SI( count_power_diagram_nb_memo ) }, SI( -1 ), NoErrorBuffer{}, SI( -1 ) )
    };
    auto power_diagram_io = PowerDiagram_Bsp_io{ InpList(), InpList(), UndefList(), UndefList(), InpList(), UndefList(), InpList(), AaBsp_io{ InpList(), InpList(), InpList(), InpList(), InpList(), InpList(), UndefList(), UndefList(), InpList(), InpList(), InpList(), InpList() }, InpList(), UndefList(), UndefList(), UndefList(), InpList() };
    ...
    auto mass = tensor_view<CudaGlobalMemorySpace>( ffi_mass->typed_data(), tuple( SI( ffi_mass->dimensions()[ 0 ] ) ), tuple( num_point ) );
    auto first = tensor_view<CudaGlobalMemorySpace>( ffi_first->typed_data(), tuple( SI( ffi_first->dimensions()[ 0 ] ), Ct<SI, 2>() ), tuple( num_point, dim ) );
    auto second = tensor_view<CudaGlobalMemorySpace>( ffi_second->typed_data(), tuple( SI( ffi_second->dimensions()[ 0 ] ) ), tuple( num_point ) );
    auto scratch = CellScratch{
        tensor_view<CudaGlobalMemorySpace>( ffi_words->typed_data(), tuple( SI( 200 ), SI( 1 ), SI( 576 ) ), tuple( thread_0, num_thread, num_word ), tuple( SI( 2304 ), SI( 2304 ), SI( 4 ) ) ),
    ...
    auto distribution = Image{
        tensor_view<CudaGlobalMemorySpace>( ffi_target_mass.typed_data(), tuple(  ), tuple(  ) ),
        Ct<SI, 2>{},
        make_shape_var_view( tensor_view<CudaGlobalMemorySpace>( ffi_shape.typed_data(), tuple( SI( ffi_shape.dimensions()[ 0 ] ) ), tuple( UnnamedAxis{} ) ), SI( max_ffi_shape ), NoErrorBuffer{}, SI( -1 ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_values.typed_data(), tuple( SI( ffi_values.dimensions()[ 0 ] ), SI( ffi_values.dimensions()[ 1 ] ) ), tuple( img_pos_0, img_pos_1 ) ),
        NoneTensor<double, Tuple<Ct<SI, 2>>, Tuple<_dim>>{},
        NoneTensor<double, Tuple<Ct<SI, 2>, Ct<SI, 2>>, Tuple<_dir, _dim>>{},
        NoneTensor<double, Tuple<Ct<SI, 2>, SI>, Tuple<_dim, _num_knot>>{},
        tensor_view<CudaGlobalMemorySpace>( ffi_current_mass.typed_data(), tuple(  ), tuple(  ) ),
        ShapeVarView<NoneTensor<std::int32_t, Tuple<>, Tuple<>>, NoErrorBuffer>{ NoneTensor<std::int32_t, Tuple<>, Tuple<>>{}, SI( -1 ), NoErrorBuffer{}, SI( -1 ) },
...
run_parallel(
    ...
    power_diagram_moments_fwd_kernel{},
    power_diagram_io, power_diagram, dom_cell_io, dom_cell, OutList(), mass, OutList(), first, OutList(), second, scratch_io, scratch, distribution_io, distribution
);
    }
