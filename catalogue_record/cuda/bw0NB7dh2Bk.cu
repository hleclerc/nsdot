...
struct power_diagram_measures_bwd_fwd_kernel {
    template<class BatchIndex, class T_power_diagram, class T_grad_for_power_diagram, class T_dom_cell, class T_grad_for_dom_cell, class T_res, class T_grad_for_res, class T_scratch, class T_distribution, class T_grad_for_distribution>
    HD void operator()( BatchIndex batch_index, int thread_index, int nb_threads, T_power_diagram power_diagram, T_grad_for_power_diagram grad_for_power_diagram, T_dom_cell dom_cell, T_grad_for_dom_cell grad_for_dom_cell, T_res res, T_grad_for_res grad_for_res, T_scratch scratch, T_distribution distribution, T_grad_for_distribution grad_for_distribution ) const {
        power_diagram.measures_bwd( res, dom_cell, grad_for_res, grad_for_power_diagram.positions, grad_for_power_diagram.weights, scratch( batch_index ), distribution, grad_for_distribution, thread_index, nb_threads );
    }
};


static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR1<ffi::S32> ffi_nb_vertices_, ffi::BufferR1<ffi::S32> ffi_nb_cuts_, ffi::BufferR1<ffi::F64> ffi_res, ffi::BufferR1<ffi::F64> ffi_grad_for_res, ffi::BufferR0<ffi::F64> ffi_target_mass, ffi::BufferR2<ffi::F64> ffi_positions__, ffi::BufferR1<ffi::F64> ffi_sigmas, ffi::BufferR1<ffi::F64> ffi_weights, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_positions_, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_grad_for_power_diagram_nb_points, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_vertices_, int64_t max_ffi_nb_cuts_, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t count_distribution_nb_gaussians, int64_t count_grad_for_distribution_nb_gaussians, int64_t nb_batch_thread_0 ) {
    ...
    auto grad_for_power_diagram_io = PowerDiagram_Plain_io{ UndefList(), UndefList(), UndefList(), UndefList(), InpList(), UndefList(), InpList(), OutList(), UndefList() };
    ...
    auto grad_for_dom_cell = Cell_2{
        ...
        make_shape_var_view( tensor_view<CudaGlobalMemorySpace>( ffi_nb_vertices_.typed_data(), tuple(  ), tuple(  ) ), SI( max_ffi_nb_vertices_ ), NoErrorBuffer{}, SI( -1 ) ),
        make_shape_var_view( tensor_view<CudaGlobalMemorySpace>( ffi_nb_cuts_.typed_data(), tuple(  ), tuple(  ) ), SI( max_ffi_nb_cuts_ ), NoErrorBuffer{}, SI( -1 ) ),
        Ct<SI, 2>{}
    };
    ...
    auto grad_for_res = tensor_view<CudaGlobalMemorySpace>( ffi_grad_for_res.typed_data(), tuple( SI( ffi_grad_for_res.dimensions()[ 0 ] ) ), tuple( num_point ) );
    ...
    auto distribution = SumOfGaussians{
        ...
        Ct<SI, 2>{},
        tensor_view<CudaGlobalMemorySpace>( ffi_positions__.typed_data(), tuple( SI( ffi_positions__.dimensions()[ 0 ] ), Ct<SI, 2>() ), tuple( num_gaussian, dim ) ),
    ...
    auto grad_for_distribution = SumOfGaussians{
        NoneTensor<double, Tuple<>, Tuple<>>{},
        make_shape_var_view( ScalarValue<SI>{ SI( count_grad_for_distribution_nb_gaussians ) }, SI( -1 ), NoErrorBuffer{}, SI( -1 ) ),
        Ct<SI, 2>{},
        NoneTensor<double, Tuple<SI, Ct<SI, 2>>, Tuple<_num_gaussian, _dim>>{},
        NoneTensor<double, Tuple<SI>, Tuple<_num_gaussian>>{},
        NoneTensor<double, Tuple<SI>, Tuple<_num_gaussian>>{},
        NoneTensor<double, Tuple<>, Tuple<>>{}
    };
    auto grad_for_distribution_io = SumOfGaussians_io{ UndefList(), InpList(), InpList(), UndefList(), UndefList(), UndefList(), UndefList() };
    errors.fill_with( queue, 0 );
    grad_for_power_diagram.positions.fill_with( queue, 0 );
...
run_parallel(
    ...
    power_diagram_io, power_diagram, grad_for_power_diagram_io, grad_for_power_diagram, dom_cell_io, dom_cell, grad_for_dom_cell_io, grad_for_dom_cell, InpList(), res, InpList(), grad_for_res, scratch_io, scratch, distribution_io, distribution, grad_for_distribution_io, grad_for_distribution
);
    }
...
XLA_FFI_DEFINE_HANDLER_SYMBOL( SDOT_FFI_ENTRY, sdot_ffi_impl,
    ffi::Ffi::Bind()
        ...
        .Attr<int64_t>( "count_grad_for_distribution_nb_gaussians" )
