...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_node_wa, ffi::BufferR1<ffi::F64> ffi_node_wb, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR1<ffi::F64> ffi_sorted_weights, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_mass, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_first, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_second, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t nb_batch_thread_0 ) {
    ...
    auto scratch = CellScratch{
        tensor_view<CudaGlobalMemorySpace>( ffi_words->typed_data(), tuple( SI( 200 ), SI( 1 ), SI( 1088 ) ), tuple( thread_0, num_thread, num_word ), tuple( SI( 4352 ), SI( 4352 ), SI( 4 ) ) ),
...
run_parallel(
    ...
    power_diagram_io, power_diagram, dom_cell_io, dom_cell, OutList(), mass, OutList(), first, OutList(), second, scratch_io, scratch
);
    }
