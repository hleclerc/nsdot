...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR0<ffi::F64> ffi_target_mass, ffi::BufferR2<ffi::F64> ffi_positions_, ffi::BufferR1<ffi::F64> ffi_sigmas, ffi::BufferR1<ffi::F64> ffi_weights, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_res, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t count_distribution_nb_gaussians, int64_t nb_batch_thread_0 ) {
    ...
    auto distribution = SumOfGaussians{
        ...
        Ct<SI, 2>{},
        tensor_view<CudaGlobalMemorySpace>( ffi_positions_.typed_data(), tuple( SI( ffi_positions_.dimensions()[ 0 ] ), Ct<SI, 2>() ), tuple( num_gaussian, dim ) ),
