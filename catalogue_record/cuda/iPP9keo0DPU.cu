...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_direction, ffi::BufferR0<ffi::F64> ffi_offset, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR2<ffi::S32> ffi_vertex_cuts, ffi::BufferR2<ffi::S32> ffi_vertex_nbrs, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_vertex_positions_, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_vertex_cuts_, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_vertex_nbrs_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_cut_ids_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_vertices_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_cuts_, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t attr_cut_id, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_vertices_, int64_t max_ffi_nb_cuts_, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words ) {
    ...
    auto direction = tensor_view<CudaGlobalMemorySpace>( ffi_direction.typed_data(), tuple( Ct<SI, 3>() ), tuple( dim_axis ) );
    auto offset = tensor_view<CudaGlobalMemorySpace>( ffi_offset.typed_data(), tuple(  ), tuple(  ) );
    auto cell = Cell_N{
    ...
    auto res = Cell_N{
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_positions_->typed_data(), tuple( SI( ffi_vertex_positions_->dimensions()[ 0 ] ), Ct<SI, 3>() ), tuple( num_vertex, dim_axis ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_cuts_->typed_data(), tuple( SI( ffi_vertex_cuts_->dimensions()[ 0 ] ), Ct<SI, 3>() ), tuple( num_vertex, dim_axis ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_nbrs_->typed_data(), tuple( SI( ffi_vertex_nbrs_->dimensions()[ 0 ] ), Ct<SI, 3>() ), tuple( num_vertex, dim_axis ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_cut_ids_->typed_data(), tuple( SI( ffi_cut_ids_->dimensions()[ 0 ] ) ), tuple( num_cut ) ),
        make_shape_var_view( tensor_view<CudaGlobalMemorySpace>( ffi_nb_vertices_->typed_data(), tuple(  ), tuple(  ) ), SI( max_ffi_nb_vertices_ ), errors, SI( 0 ) ),
        make_shape_var_view( tensor_view<CudaGlobalMemorySpace>( ffi_nb_cuts_->typed_data(), tuple(  ), tuple(  ) ), SI( max_ffi_nb_cuts_ ), errors, SI( 1 ) ),
        Ct<SI, 3>{}
    };
