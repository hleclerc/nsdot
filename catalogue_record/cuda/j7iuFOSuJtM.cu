...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR1<ffi::S64> ffi_seed_indices, ffi::BufferR1<ffi::S64> ffi_node_left, ffi::BufferR1<ffi::S64> ffi_node_right, ffi::BufferR1<ffi::S64> ffi_node_begin, ffi::BufferR1<ffi::S64> ffi_node_end, ffi::BufferR3<ffi::F64> ffi_node_box, ffi::BufferR2<ffi::F64> ffi_node_wa, ffi::BufferR1<ffi::F64> ffi_node_wb, ffi::BufferR2<ffi::F64> ffi_sorted_positions, ffi::BufferR1<ffi::F64> ffi_sorted_weights, ffi::BufferR2<ffi::S32> ffi_memo_nbrs, ffi::BufferR1<ffi::S32> ffi_memo_counts, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR2<ffi::S32> ffi_vertex_cuts, ffi::BufferR2<ffi::S32> ffi_vertex_nbrs, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR1<ffi::S64> ffi_ranks, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR3<ffi::F64>> ffi_vertex_positions_, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_vertex_cuts_, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_vertex_nbrs_, ffi::Result<ffi::BufferR2<ffi::S32>> ffi_cut_ids_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_vertices_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_cuts_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_power_diagram_tree_nb_bsp_seeds, int64_t count_power_diagram_tree_nb_bsp_nodes, int64_t count_power_diagram_nb_memo, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t max_ffi_nb_vertices_, int64_t max_ffi_nb_cuts_, int64_t nb_batch_cell_0 ) {
    ...
    auto cells = Cell_N{
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_positions_->typed_data(), tuple( SI( 200 ), SI( 128 ), Ct<SI, 3>() ), tuple( cell_0, num_vertex, dim_axis ), tuple( SI( 3072 ), SI( 24 ), SI( 8 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_cuts_->typed_data(), tuple( SI( 200 ), SI( 128 ), Ct<SI, 3>() ), tuple( cell_0, num_vertex, dim_axis ), tuple( SI( 1536 ), SI( 12 ), SI( 4 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_vertex_nbrs_->typed_data(), tuple( SI( 200 ), SI( 128 ), Ct<SI, 3>() ), tuple( cell_0, num_vertex, dim_axis ), tuple( SI( 1536 ), SI( 12 ), SI( 4 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_cut_ids_->typed_data(), tuple( SI( 200 ), SI( 128 ) ), tuple( cell_0, num_cut ), tuple( SI( 512 ), SI( 4 ) ) ),
