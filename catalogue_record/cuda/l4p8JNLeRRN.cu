...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR1<ffi::F64> ffi_box_min, ffi::BufferR1<ffi::F64> ffi_box_max, ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR1<ffi::F64> ffi_weights, ffi::BufferR2<ffi::F64> ffi_vertex_positions, ffi::BufferR2<ffi::S32> ffi_vertex_cuts, ffi::BufferR2<ffi::S32> ffi_vertex_nbrs, ffi::BufferR1<ffi::S32> ffi_cut_ids, ffi::BufferR1<ffi::S32> ffi_nb_vertices, ffi::BufferR1<ffi::S32> ffi_nb_cuts, ffi::BufferR1<ffi::S32> ffi_nb_vertices_, ffi::BufferR1<ffi::S32> ffi_nb_cuts_, ffi::BufferR1<ffi::F64> ffi_res, ffi::BufferR1<ffi::F64> ffi_grad_for_res, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_positions_, ffi::Result<ffi::BufferR3<ffi::S32>> ffi_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_threads, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_words, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t count_power_diagram_nb_points, int64_t count_grad_for_power_diagram_nb_points, int64_t max_ffi_nb_vertices, int64_t max_ffi_nb_cuts, int64_t max_ffi_nb_vertices_, int64_t max_ffi_nb_cuts_, int64_t max_ffi_nb_threads, int64_t max_ffi_nb_words, int64_t nb_batch_thread_0 ) {
    ...
    auto grad_for_power_diagram = PowerDiagram_Plain{
        ...
        ShapeVarView<NoneTensor<std::int32_t, Tuple<>, Tuple<>>, NoErrorBuffer>{ NoneTensor<std::int32_t, Tuple<>, Tuple<>>{}, SI( -1 ), NoErrorBuffer{}, SI( -1 ) },
        Ct<SI, 3>{},
        tensor_view<CudaGlobalMemorySpace>( ffi_positions_->typed_data(), tuple( SI( ffi_positions_->dimensions()[ 0 ] ), Ct<SI, 3>() ), tuple( num_point, dim ) ),
    ...
    auto grad_for_dom_cell = Cell_N{
        NoneTensor<double, Tuple<SI, Ct<SI, 3>>, Tuple<_num_vertex, _dim_axis>>{},
        NoneTensor<std::int32_t, Tuple<SI, Ct<SI, 3>>, Tuple<_num_vertex, _dim_axis>>{},
        NoneTensor<std::int32_t, Tuple<SI, Ct<SI, 3>>, Tuple<_num_vertex, _dim_axis>>{},
    ...
    auto grad_for_dom_cell_io = Cell_N_io{ UndefList(), UndefList(), UndefList(), UndefList(), InpList(), InpList(), InpList() };
