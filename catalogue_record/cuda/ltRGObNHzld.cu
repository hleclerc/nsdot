...
static ffi::Error sdot_ffi_impl( cudaStream_t xla_stream, ffi::BufferR2<ffi::F64> ffi_positions, ffi::BufferR1<ffi::F64> ffi_weights, ffi::BufferR1<ffi::S64> ffi_order, ffi::BufferR1<ffi::S32> ffi_nb_points, ffi::BufferR1<ffi::S64> ffi_begin, ffi::BufferR1<ffi::S64> ffi_end, ffi::BufferR1<ffi::S64> ffi_leaf_size, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_positions_, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_weights_, ffi::Result<ffi::BufferR1<ffi::S64>> ffi_order_, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_nb_points_, ffi::Result<ffi::BufferR1<ffi::S64>> ffi_mid, ffi::Result<ffi::BufferR3<ffi::F64>> ffi_box, ffi::Result<ffi::BufferR2<ffi::F64>> ffi_wa, ffi::Result<ffi::BufferR1<ffi::F64>> ffi_wb, ffi::Result<ffi::BufferR1<ffi::S64>> ffi_perm, ffi::Result<ffi::BufferR1<ffi::S32>> ffi_errors, int64_t max_ffi_nb_points, int64_t max_ffi_nb_points_, int64_t nb_batch_bspnode_0 ) {
    ...
    auto lvl = _BspLevel{
        ...
        tensor_view<CudaGlobalMemorySpace>( ffi_mid->typed_data(), tuple( SI( 4 ) ), tuple( bspnode_0 ), tuple( SI( 8 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_box->typed_data(), tuple( SI( 4 ), Ct<SI, 2>(), Ct<SI, 3>() ), tuple( bspnode_0, num_lohi, dim ), tuple( SI( 48 ), SI( 24 ), SI( 8 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_wa->typed_data(), tuple( SI( 4 ), Ct<SI, 3>() ), tuple( bspnode_0, dim ), tuple( SI( 24 ), SI( 8 ) ) ),
        tensor_view<CudaGlobalMemorySpace>( ffi_wb->typed_data(), tuple( SI( 4 ) ), tuple( bspnode_0 ), tuple( SI( 8 ) ) ),
        Ct<SI, 2>{},
        Ct<SI, 3>{}
    };
