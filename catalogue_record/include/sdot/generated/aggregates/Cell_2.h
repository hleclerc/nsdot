...
#define SDOT_TEMPLATE_DECL_FOR_Cell_2 template<class T_vertex_positions, class T_cut_ids, class T_nb_vertices, class T_nb_cuts, class T_nb_dims>


#define SDOT_TEMPLATE_ARGS_FOR_Cell_2 T_vertex_positions, T_cut_ids, T_nb_vertices, T_nb_cuts, T_nb_dims

namespace sdot {
template<class T_vertex_positions, class T_cut_ids, class T_nb_vertices, class T_nb_cuts, class T_nb_dims>
struct Cell_2_io {
...
#define SDOT_ATTRIBUTES_OF_Cell_2 \
    T_vertex_positions vertex_positions; \
    T_cut_ids cut_ids; \
    T_nb_vertices nb_vertices; \
    T_nb_cuts nb_cuts; \
 ...
 \
    HD auto operator()( const auto &...index ) const { \
        return ::sdot::Cell_2{ vertex_positions( index... ), cut_ids( index... ), nb_vertices( index... ), nb_cuts( index... ), nb_dims( index... ) }; \
    } \
 \
 ...
 \
    auto kernel_form( auto &&queue, auto io ) const { \
        return ::sdot::Cell_2{ sdot::kernel_form( queue, io_of_vertex_positions( io ), vertex_positions ), sdot::kernel_form( queue, io_of_cut_ids( io ), cut_ids ), sdot::kernel_form( queue, io_of_nb_vertices( io ), nb_vertices ), sdot::kernel_form( queue, io_of_nb_cuts( io ), nb_cuts ), sdot::kernel_form( queue, io_of_nb_dims( io ), nb_dims ) }; \
    }
